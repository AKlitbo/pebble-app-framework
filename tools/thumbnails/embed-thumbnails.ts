...
import { faceDir, listFaceNames } from '../faces.ts';
...
export function buildSource(thumbs: Thumbs, order: Record<string, number>): string {
  const lines = [
    '// generated by tools/thumbnails/embed-thumbnails.ts',
    '// do not edit by hand: run `npm run gen:thumbnails` after changing the pictures',
    'module.exports = {',
  ];
  Object.keys(thumbs)
