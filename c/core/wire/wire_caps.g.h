...
#define SETTINGS_REQUEST_FULL 1 ///< A settings request for the watch's whole snapshot
#define SETTINGS_REQUEST_FRESH 2 ///< A settings request for only whether the watch booted empty
